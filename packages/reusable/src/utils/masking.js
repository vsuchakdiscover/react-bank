/*
  Needed to modify this addon to force the mask to force showing decimal points
  createNumberMask addon docs - https://github.com/text-mask/text-mask/tree/master/addons/#readme 
  Original addon source https://github.com/text-mask/text-mask/blob/master/addons/src/createNumberMask.js
 **/
...
export function createNumberMask({
  ...
  function numberMask(rawValue = emptyString) {
    ...
    // START: Modification from source

    // Prevent 0 from being entered first
    mask[1] = /[1-9]/;
